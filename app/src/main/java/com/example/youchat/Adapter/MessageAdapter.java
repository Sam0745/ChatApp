...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        boolean isCurrentUser = message.getSenderId().equals(FirebaseAuth.getInstance().getCurrentUser().getUid());
    ...
    private void updatePlayPauseButton() {
        /*MessageAdapter.MyViewHolder viewHolder = (MessageAdapter.MyViewHolder) recyclerView.findViewHolderForAdapterPosition(currentPlayingPosition);*/
        MessageAdapter.MyViewHolder viewHolder = (MessageAdapter.MyViewHolder) recyclerView.findViewHolderForAdapterPosition(currentPlayingPosition);
        if (viewHolder != null) {
    ...
    private void updatePlaybackProgress(int position) {
        ...
        MessageAdapter.MyViewHolder viewHolder = (MessageAdapter.MyViewHolder) recyclerView.findViewHolderForAdapterPosition(position);
        if (viewHolder != null) {
            SeekBar seekBar;
